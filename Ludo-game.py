...
logo = PhotoImage(file="images/whitebox.gif")      # Loading all the image files that are required in the game.
logo2 = PhotoImage(file="images/red side.gif")     # Loading all the image files that are required in the game.
logo3 = PhotoImage(file="images/red.gif")          # Loading all the image files that are required in the game.
logo4 = PhotoImage(file="images/blue side.gif")
logo5 = PhotoImage(file="images/green side.gif")
logo6 = PhotoImage(file="images/yellow side.gif")
logo7 = PhotoImage(file="images/center.gif")
logoxx = PhotoImage(file="images/test.gif")
logog = PhotoImage(file="images/greenbox.gif")
logogs = PhotoImage(file="images/greenstop.gif")
logoy = PhotoImage(file="images/yellowbox.gif")
logoys = PhotoImage(file="images/yellowstop.gif")
logob = PhotoImage(file="images/bluebox.gif")
logobs = PhotoImage(file="images/bluestop.gif")
logor = PhotoImage(file="images/redbox.gif")
logors = PhotoImage(file="images/redstop.gif")
logoh = PhotoImage(file="images/head.gif")
logot = PhotoImage(file="images/tail.gif")
logoh1 = PhotoImage(file="images/head1.gif")
logot1 = PhotoImage(file="images/tail1.gif")
logoh2 = PhotoImage(file="images/head2.gif")
logot2 = PhotoImage(file="images/tail2.gif")
logoh3 = PhotoImage(file="images/head3.gif")
logot3 = PhotoImage(file="images/tail3.gif")
logoab= PhotoImage(file="images/blue.gif")
logoay= PhotoImage(file="images/yellow.gif")
logoag= PhotoImage(file="images/green.gif")
